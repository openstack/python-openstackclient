...
class TestQosAssociate(volume_fakes.TestVolume):
    def setUp(self):
        ...
        self.volume_client.find_qos_spec.return_value = self.qos_spec
    ...
    def test_qos_associate(self):
        ...
        self.volume_client.find_qos_spec.assert_called_once_with(
        ...
        self.volume_client.associate_qos_spec.assert_called_once_with(
...
class TestQosCreate(volume_fakes.TestVolume):
    ...
    def setUp(self):
        ...
        self.volume_client.create_qos_spec.return_value = self.new_qos_spec
    ...
    def test_qos_create_without_properties(self):
        ...
        self.volume_client.create_qos_spec.assert_called_once_with(
...
class TestQosDelete(volume_fakes.TestVolume):
    def setUp(self):
        ...
        self.volume_client.find_qos_spec.side_effect = lambda x, **kwargs: (
            qos_by_id[x]
        )
    ...
    def test_qos_delete(self):
        ...
        self.volume_client.delete_qos_spec.assert_called_once_with(
    ...
    def test_delete_multiple_qoses(self):
        ...
        self.volume_client.delete_qos_spec.assert_has_calls(calls)
        self.assertIsNone(result)
...
class TestQosDisassociate(volume_fakes.TestVolume):
    ...
    def test_qos_disassociate_with_volume_type(self):
        ...
        self.volume_client.disassociate_qos_spec.assert_called_once_with(
            self.qos_spec.id, self.volume_type.id
        )
        self.assertIsNone(result)
    ...
    def test_qos_disassociate_with_all_volume_types(self):
        ...
        self.volume_client.disassociate_all_qos_spec.assert_called_once_with(
            self.qos_spec.id
        )
        self.assertIsNone(result)
...
class TestQosList(volume_fakes.TestVolume):
    ...
    def setUp(self):
        ...
        self.volume_client.qos_specs.return_value = self.qos_specs
        self.volume_client.qos_spec_associations.return_value = [
    ...
    def test_qos_list(self):
        ...
        columns, data = self.cmd.take_action(parsed_args)
        self.volume_client.qos_specs.assert_called_once_with()
...
class TestQosSet(volume_fakes.TestVolume):
    ...
    def test_qos_set_with_properties_with_id(self):
        ...
        self.volume_client.delete_qos_spec_metadata.assert_called_once_with(
            self.qos_spec.id,
            list(self.qos_spec.specs.keys()),
        )
        self.volume_client.update_qos_spec.assert_called_once_with(
